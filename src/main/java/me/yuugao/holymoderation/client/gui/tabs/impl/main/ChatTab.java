...
public class ChatTab extends SettingsTab {
    ...
    protected void renderExtra(DrawContext ctx, ThemePalette palette, float pW, float pH, int z, float scroll) {
        ...
        for (int i = 0; i < texts.size(); i++) {
            ...
            render2DService.renderSoftRoundedRect(ctx, PAD, rowY, bodyW, rowH, z,
            ...
            render2DService.renderSoftRoundedRectOutline(ctx, editX, rowY, editW, rowH, z,
                    6f, palette.surface, palette.outline, 1f, 1f);
            renderCenteredGlyph(ctx, z, "✎", editX, rowY, editW, rowH, tr, palette.textSecondary);

            render2DService.renderSoftRoundedRectOutline(ctx, delX, rowY, delW, rowH, z,
                    6f, palette.surface, palette.outline, 1f, 1f);
