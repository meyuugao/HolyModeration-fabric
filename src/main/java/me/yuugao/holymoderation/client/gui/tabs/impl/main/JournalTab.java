...
public class JournalTab extends SettingsTab {
    ...
    private void renderCard(DrawContext ctx, int z, ThemePalette palette, float x, float y, float w, float h) {
        render2DService.renderSoftRoundedRect(ctx, x, y, w, h, z, 10f, palette.surface, 0);
        render2DService.renderSoftRoundedRectOutline(ctx, x, y, w, h, z, 10f, palette.surface, palette.outline, 1f, 1f);
    }
