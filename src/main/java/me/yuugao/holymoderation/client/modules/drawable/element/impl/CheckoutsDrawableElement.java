...
import me.yuugao.holymoderation.client.modules.drawable.element.state.impl.CheckoutsRenderState;
import me.yuugao.holymoderation.client.modules.drawable.element.state.provider.impl.CheckoutsRenderStateProvider;
...
public class CheckoutsDrawableElement extends StatefulDrawableElement<CheckoutsRenderState> {
    ...
    private void renderContent(String display, DrawContext ctx, int z) {
        ...
        this.currentWidth = animate(currentWidth, targetWidth, 1.2f);
        this.currentHeight = animate(currentHeight, targetHeight, 1.2f);
